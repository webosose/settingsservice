...
class Trackable {
 public:
    ...
    virtual ~ Trackable() {
        for (std::set < Sender * >::iterator it = m_senders.begin(); it != m_senders.end(); ++it) {
...
template < class Function > class FunctionWrapper {
 public:
...
template < class Arg0 = void, class Arg1 = void, class Arg2 = void, class Arg3 = void, class Arg4 = void >class SlotBase {
 public:

    virtual void fire(Arg0 arg0, Arg1 arg1, Arg2 arg2, Arg3 arg3, Arg4 arg4) = 0;
};

template <> class SlotBase < void, void, void, void, void > {
 public:

    virtual void fire() = 0;
};

template < class Arg0 > class SlotBase < Arg0, void, void, void, void > {
 public:

    virtual void fire(Arg0 arg0) = 0;
};

template < class Arg0, class Arg1 > class SlotBase < Arg0, Arg1, void, void, void > {
 public:

    virtual void fire(Arg0 arg0, Arg1 arg1) = 0;
};

template < class Arg0, class Arg1, class Arg2 > class SlotBase < Arg0, Arg1, Arg2, void, void > {
 public:

    virtual void fire(Arg0 arg0, Arg1 arg1, Arg2 arg2) = 0;
};

template < class Arg0, class Arg1, class Arg2, class Arg3 > class SlotBase < Arg0, Arg1, Arg2, Arg3, void > {
 public:

    virtual void fire(Arg0 arg0, Arg1 arg1, Arg2 arg2, Arg3 arg3) = 0;
};

template < class Receiver, class Arg0 = void, class Arg1 = void, class Arg2 = void, class Arg3 = void, class Arg4 = void >class Slot:public SlotBase < Arg0, Arg1, Arg2, Arg3, Arg4 >, public FunctionWrapper < void (*) () > {
 public:
...
template < class Receiver > class Slot < Receiver, void, void, void, void, void >:public SlotBase <>, public FunctionWrapper < void (Receiver::*) () > {
 public:
...
template < class Receiver, class Arg0 > class Slot < Receiver, Arg0, void, void, void, void >:public SlotBase < Arg0 >, public FunctionWrapper < void (Receiver::*) (Arg0) > {
 public:
...
template < class Receiver, class Arg0, class Arg1 > class Slot < Receiver, Arg0, Arg1, void, void, void >:public SlotBase < Arg0, Arg1 >, public FunctionWrapper < void (Receiver::*) (Arg0, Arg1) > {
 public:
...
template < class Receiver, class Arg0, class Arg1, class Arg2 > class Slot < Receiver, Arg0, Arg1, Arg2, void, void >:public SlotBase < Arg0, Arg1, Arg2 >, public FunctionWrapper < void (Receiver::*) (Arg0, Arg1, Arg2) > {
 public:
...
template < class Receiver, class Arg0, class Arg1, class Arg2, class Arg3 > class Slot < Receiver, Arg0, Arg1, Arg2, Arg3, void >:public SlotBase < Arg0, Arg1, Arg2, Arg3 >, public FunctionWrapper < void (Receiver::*) (Arg0, Arg1, Arg2, Arg3) > {
 public:
...
template < class Arg0 = void, class Arg1 = void, class Arg2 = void, class Arg3 = void, class Arg4 = void >class SignalBase:public Sender {
 public:

    typedef Slot < Trackable, Arg0, Arg1, Arg2, Arg3, Arg4 > Sl;

     virtual ~ SignalBase() {
        for (typename SlotSet::const_iterator it = this->m_slots.begin(); it != this->m_slots.end(); ++it) {
...
template < class Arg0 = void, class Arg1 = void, class Arg2 = void, class Arg3 = void, class Arg4 = void >class Signal:public SignalBase < Arg0, Arg1, Arg2, Arg3, Arg4 > {
 public:

    template < class Receiver > void connect(Receiver * rec, void (Receiver::*func) (Arg0, Arg1, Arg2, Arg3, Arg4)) {
...
template <> class Signal < void, void, void, void, void >:public SignalBase <> {
 public:

    template < class Receiver > void connect(Receiver * rec, void (Receiver::*func) ()) {
...
template < class Arg0 > class Signal < Arg0, void, void, void, void >:public SignalBase < Arg0 > {
 public:

    template < class Receiver > void connect(Receiver * rec, void (Receiver::*func) (Arg0)) {
...
template < class Arg0, class Arg1 > class Signal < Arg0, Arg1, void, void, void >:public SignalBase < Arg0, Arg1 > {
 public:

    template < class Receiver > void connect(Receiver * rec, void (Receiver::*func) (Arg0, Arg1)) {
...
template < class Arg0, class Arg1, class Arg2 > class Signal < Arg0, Arg1, Arg2, void, void >:public SignalBase < Arg0, Arg1, Arg2 > {
 public:

    template < class Receiver > void connect(Receiver * rec, void (Receiver::*func) (Arg0, Arg1, Arg2)) {
...
template < class Arg0, class Arg1, class Arg2, class Arg3 > class Signal < Arg0, Arg1, Arg2, Arg3, void >:public SignalBase < Arg0, Arg1, Arg2, Arg3 > {
 public:

    template < class Receiver > void connect(Receiver * rec, void (Receiver::*func) (Arg0, Arg1, Arg2, Arg3)) {
